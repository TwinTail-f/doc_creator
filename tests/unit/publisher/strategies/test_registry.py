...
class TestCreateStrategy:
    """Тесты для create_strategy()."""

    @pytest.mark.business_logic
    def test_create_strategy_unknown_type_raises_value_error(self) -> None:
...
class TestAvailableStrategies:
    """Тесты для available_strategies()."""

    @pytest.mark.contract
    def test_all_three_strategy_types_registered(self) -> None:
